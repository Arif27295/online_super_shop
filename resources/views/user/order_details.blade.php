      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <h6 class="text-white text-capitalize ps-3 d-flex justify-content-between m-0 align-items-center"><span>Ordered Items</span> <a class="m-0 text-white text-capitalize btn bg-primary me-3" href="{{route('user_order')}}">Back</a></h6>
              </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
               ...
               <div class="card my-4">
                 <div class="card-body px-0 " style="margin: 0px 1rem">
                    <form action="{{route('order_cancel')}}" method="post" style="text-align:end">
                        @csrf
                        @method('PUT')
                        <div style="display:inline-flex;align-items:center">
                            <input type="hidden" name="order_id" value="{{$order->id}}">
                            <button type="submit" class="btn bg-gradient-warning w-100 my-4 mb-2 mt-0">Cancel Order</button>
                        </div>
                    </form>
                </div>
                @endif
