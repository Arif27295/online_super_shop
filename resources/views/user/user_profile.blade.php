...
<div class="container-fluid py-2">
      <div class="row">
            ...
            <div class="card-body px-0 pb-2 mb-4" style="margin: 0px 1rem">
              <div class="table-responsive p-0" style="width:50%">
                <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                    ...
                    @method('patch')
                    <div>
                        <x-input-label for="update_password_current_password" :value="__('Name')" />
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-body px-0 pb-2 mb-4" style="margin: 0px 1rem">
                <h6 class="text-dark text-capitalize ps-3 d-flex justify-content-between m-0 align-items-center">Delete Account</h6>
                <p class="mt-1 text-sm text-gray-600 ps-3">
