                    ...
                    @if($orders->count() > 0)
                        ...
                        <tr>
                            ...
                            <td class="align-middle" style="text-align:center">
                                <a href="{{route('user_order_details', $order->id)}}" style="color:#233A95;"><i class="ri-eye-line"></i></a>
                            </td>
                            </tr>
                        @endforeach
                        @endif
                      <tr><td colspan="10" style="text-align:center;"> <p class="text-xs text-secondary mb-0">No order here.</p><td></tr> 
                  </tbody>
                </table>
              </div>
            </div>
