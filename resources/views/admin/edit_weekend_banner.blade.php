        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2" style="margin:1rem">
               <form class="text-start" method="post" action="{{route('update_weekend_banner', $banner->id)}}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" name="offer" placeholder="Offer.. "  value="{{$banner->discount_offer}}" class="form-control"><br>
