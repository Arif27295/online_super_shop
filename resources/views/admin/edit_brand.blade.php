        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2" style="margin:1rem">
               <form role="form" class="text-start" method="post" action="{{route('update_brand',$edit_data->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview">
							            <img src="{{asset('brand_image')}}/{{$edit_data->image}}" value="{{$edit_data->image}}" class="effect8" alt="{{$edit_data->image}}" name="image">
                        </div>
