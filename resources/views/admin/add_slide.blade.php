        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2" style="margin:1rem">
               <form class="text-start" method="post" action="{{route('create_slider')}}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" name="description" placeholder="Description.. "  value="{{old('description')}}" class="form-control"><br>
                    <span class='text-danger'>@error('description') {{$message}} @enderror</span>
                  </div>
                  <div class="input-group input-group-outline my-3">
                    <div class="brand-label"><label>Price<sup class="text-primary">*</sup></label></div>
                    <input type="number" name="price" placeholder="Price.. " step=".01"  value="{{old('price')}}" class="form-control"><br>
                    <span class='text-danger'>@error('price') {{$message}} @enderror</span>
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    <div class="brand-label"><label>Discount Offer</label></div>
                    <input type="number" name="discount_offer" class="form-control" step="0.01" value="{{old('discount_offer')}}" placeholder="Offer..">
