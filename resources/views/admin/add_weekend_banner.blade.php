          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 d-flex justify-content-between m-0 align-items-center"><span>Banner Information</span> <a class="m-0 text-white text-capitalize btn bg-primary me-3" href="{{route('weekend_banner')}}">Back</a></h6>
				
              </div>
            </div>
            <div class="card-body px-0 pb-2" style="margin:1rem">
               <form class="text-start" method="post" action="{{route('create_weekend_banner')}}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" name="subtitle" placeholder="Subtitle.. "  value="{{old('subtitle')}}" class="form-control"><br>
                    <span class='text-danger'>@error('subtitle') {{$message}} @enderror</span>
                  </div>
                  <div class="input-group input-group-outline my-3">
                    <div class="brand-label"><label>Discount Offer<sup class="text-primary">*</sup></label></div>
                    <input type="text" name="offer" placeholder="Offer.. "  value="{{old('offer')}}" class="form-control"><br>
