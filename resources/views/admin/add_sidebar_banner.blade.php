        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2" style="margin:1rem">
               <form class="text-start" method="post" action="{{route('create_sidebar_banner')}}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" name="tag" placeholder="Tag.. "  value="{{old('tag')}}" class="form-control"><br>
