        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <h6 class="text-white text-capitalize ps-3 d-flex justify-content-between m-0 align-items-center"><span>Banner</span> <a class="m-0 text-white text-capitalize btn bg-success me-3" href="{{route('add_leftside_banner')}}">Add Banner</a></h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$banner->tag}}</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$banner->price}}</p>
                      </td>
                      <td class="align-middle" style="text-align:center">
                        <a href="edit_sidebar_banner/{{$banner->id}}" class="badge badge-sm bg-gradient-success me-2">Edit</a>
                        <a href="delete_sidebar_banner/{{$banner->id}}" class="badge badge-sm bg-gradient-primary">delete</a>
                      </td>
                    </tr>
                    @endforeach
                  @else
                  <tr><td colspan="7" style="text-align:center;"> <p class="text-xs text-secondary mb-0">No data here..</p><td></tr>
                  @endif
                  </tbody>
                </table>
