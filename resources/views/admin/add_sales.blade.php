...
<div class="row">
        <div class="col-12">
          <div class="card my-4">
            ...
            <form role="form" class="text-start" id="SubmitForm" acction="{{route('add_sals_product')}}" method="post">
                @csrf
              <div class="row">
					      <div class="col-6">
                  ...
                  <div class="card-body px-0 pb-2" style="margin:1rem">
                    ...
                    <div class="input-group input-group-outline mt-0" style="padding-right:30px">
                      <input type="text" id="issu_for_name" value="{{old('issu_for_name')}}" name="issu_for_name" placeholder="First Name.. " class="form-control pro_input" required><br>
                      <span class='text-danger'>@error('issu_for_name') {{$message}} @enderror</span>
                    </div>
                    <div class="input-group input-group-outline mt-0" style="padding-right:30px">
                      <input type="number" id="issu_for_num" value="{{old('issu_for_num')}}" name="issu_for_num" placeholder="Number.." class="form-control pro_input" required><br>
                      <span class='text-danger'>@error('issu_for_num') {{$message}} @enderror</span>
                    </div>
                    <div class="input-group input-group-outline mt-0" style="padding-right:30px">
                      <input type="email" id="issu_for_email" value="{{old('issu_for_email')}}" name="issu_for_email" placeholder="Emial.." class="form-control pro_input" required><br>
                    ...
                    <div class="input-group input-group-outline" style="padding-right:30px">
                      <textarea class="form-control pro_input" value="{{old('issu_for_address')}}" name="issu_for_address" placeholder="Address.." required></textarea><br>
                  ...
                  <div class="card-body px-0 pb-2" style="margin:1rem;padding-right:30px !important;">
                        <table class="table align-items-center mb-0 table-striped" style="border:1px solid #e5e5e5;">
                            ...
                            <tr>
                              ...
                              <td style="border-bottom:1px solid #e5e5e5"><p class="text-xs font-weight-bold mb-0">$<input name='subtotal' class="sals_checkout bg-transparent" readonly id="grand-total" style="width:50px"></p></td>
                            </tr>
                            <tr>
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Discount</th>
                              <td style="border-bottom:1px solid #e5e5e5"><p class="text-xs font-weight-bold mb-0">$<input name="discount" class="sals_checkout bg-transparent" readonly id="discount-value" style="width:50px"></p></td>
                            </tr>
                            <tr>
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Total</th>
                              <td style="border-bottom:1px solid #e5e5e5"><p class="text-xs font-weight-bold mb-0">$<input name="total" class="sals_checkout bg-transparent font-weight-bold text-primary" readonly id="sum-total" style="width:50px"></p></td>
                            </tr>
                            <tr>
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Paid</th>
                              <td style="border-bottom:1px solid #e5e5e5"><p class="text-xs font-weight-bold mb-0">$<input name="paid" class="sals_checkout bg-transparent paid" readonly  style="width:50px"></p></td>
                            </tr>
                            <tr>
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Due</th>
                              <td style="border-bottom:1px solid #e5e5e5"><p class="text-xs font-weight-bold mb-0">$<input name="due" class="sals_checkout bg-transparent due" readonly  style="width:50px"></p></td>
                            </tr>
                        </table>
